            ...
            <div class="col-md-12 clearfix">
                ...
                if (isset($_COOKIE['user_cart'])) {
                    ...
                    if (count($result) > 0) { ?>
                        ...
                        <?php } else { ?>
                            <a class="btn btn-sm btn-success text-uppercase pull-right" href="#" data-toggle="modal" data-target="#userLogin_form">Proceed to Checkout</a>
                        <?php } ?>
                    <?php   }
                } else { ?>
                    <div class="fs-3 text-muted text-capitalize  d-flex justify-content-center align-items-center" style="min-height: 200px">
